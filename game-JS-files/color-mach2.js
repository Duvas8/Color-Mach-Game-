...
colorsTable2 = ['#FFE4C4', '#DEB887', '#D2691E', '#FF7F50', '#A52A2A', '#DC143C', '#8B0000', '#E9967A', '#CD5C5C', '#FFB6C1', '#DB7093'];
...
function random1(){
i = Math.floor(Math.random()* colorsTable2.length);
num1.style.backgroundColor = colorsTable2[i]; 
avatarColor1.style.backgroundColor = colorsTable2[i];
};

function random2(){
a = Math.floor(Math.random()* colorsTable2.length); 
num2.style.backgroundColor = colorsTable2[a];
avatarColor2.style.backgroundColor = colorsTable2[a];
};

function random3(){
b = Math.floor(Math.random()* colorsTable2.length); 
num3.style.backgroundColor = colorsTable2[b];
avatarColor3.style.backgroundColor = colorsTable2[b];
};

function random4(){
c = Math.floor(Math.random()* colorsTable2.length); 
num4.style.backgroundColor = colorsTable2[c];
avatarColor4.style.backgroundColor = colorsTable2[c];
};
