...
const colorsTable4 = ['#2E8B57','#87CEEB','#6A5ACD','#4682B4','#008080','#40E0D0','#FFC0CB','#663399','#98FB98','#AFEEEE', '#90EE90', '#E0FFFF', '#1E90FF', '#BA55D3', '#191970'];
...
function random1(){
i = Math.floor(Math.random()* colorsTable4.length);
num1.style.backgroundColor = colorsTable4[i]; 
avatarColor1.style.backgroundColor = colorsTable4[i];
};

function random2(){
a = Math.floor(Math.random()* colorsTable4.length); 
num2.style.backgroundColor = colorsTable4[a];
avatarColor2.style.backgroundColor = colorsTable4[a];
};

function random3(){
b = Math.floor(Math.random()* colorsTable4.length); 
num3.style.backgroundColor = colorsTable4[b];
avatarColor3.style.backgroundColor = colorsTable4[b];
};

function random4(){
c = Math.floor(Math.random()* colorsTable4.length); 
num4.style.backgroundColor = colorsTable4[c];
avatarColor4.style.backgroundColor = colorsTable4[c];
};
